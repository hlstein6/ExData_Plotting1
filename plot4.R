...
# set up multiple plot format
par(mfrow=c(2,2))

#top left plot
plot(strptime(subsetPower$dateTime, "%Y-%m-%d %H:%M:%S"), subsetPower$Global_active_power, type="l", 
     ylab="Global Active Power (kilowatts)", xlab="")

# top right plot
plot(strptime(subsetPower$dateTime, "%Y-%m-%d %H:%M:%S"), subsetPower$Voltage, type="l", 
...
# bottom right plot
plot(strptime(subsetPower$dateTime, "%Y-%m-%d %H:%M:%S"), subsetPower$Global_reactive_power , type="l", 
